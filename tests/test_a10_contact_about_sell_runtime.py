...
def test_a10_contact_and_sell_pages_keep_page_owned_cta_hierarchy(client) -> None:
    ...
    channels_index = contact_html.index('id="contact-channels"')
    map_index = contact_html.index('id="contact-map"')
    ...
    docs_index = sell_html.index('id="seller-docs"')
    trust_index = sell_html.index('id="seller-trust"')
    cta_index = sell_html.index('id="seller-cta"')
    assert intent_index < process_index < docs_index < trust_index < cta_index

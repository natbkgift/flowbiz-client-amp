...
class DataFetcher(ABC):
    ...
    @abstractmethod
    def fetch_leads_by_date_range(self, start_date: date, end_date: date) -> List[Lead]:
...
class GoogleSheetsDataFetcher(DataFetcher):
    ...
    def fetch_leads_by_date_range(self, start_date: date, end_date: date) -> List[Lead]:
        ...
        return [
            ...
            if lead.date_created and start_date <= lead.date_created <= end_date
        ]
...
class MockDataFetcher(DataFetcher):
    ...
    def _generate_mock_leads(self) -> List[Lead]:
        ...
        from .schemas.lead import InterestType, LeadPriority, LeadStatus

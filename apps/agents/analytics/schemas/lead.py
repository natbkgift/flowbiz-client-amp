...
class Lead:
    ...
    def is_active(self) -> bool:
        ...
        inactive_statuses = {LeadStatus.CONVERTED, LeadStatus.LOST, LeadStatus.UNQUALIFIED}
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "date_last_contact": self.date_last_contact.isoformat()
            if self.date_last_contact
            else None,

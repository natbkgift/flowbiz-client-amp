...
const TRANSLATIONS = {
  th: {
    ...
    project_sort: 'เรียงลำดับ',
    project_sort_completion_nearest: 'วันที่แล้วเสร็จ: ใกล้สุดก่อน',
    project_sort_price_low: 'ราคา: ต่ำไปสูง',
    project_sort_price_high: 'ราคา: สูงไปต่ำ',
    project_sort_yield_high: 'ผลตอบแทน: สูงไปต่ำ',
    project_sort_units_available: 'ยูนิตว่าง: มากไปน้อย',
    project_all: 'ทั้งหมด',
    ...
    project_detail_units: 'ยูนิต',
    project_detail_facilities: 'สิ่งอำนวยความสะดวก',
    project_detail_location_map: 'แผนที่',
    project_detail_description: 'รายละเอียดโครงการ',
    project_detail_info: 'ข้อมูลโครงการ',
    project_detail_pricing: 'ราคาและการเงิน',
    project_detail_units_info: 'ข้อมูลยูนิต',
    project_detail_timeline: 'ระยะเวลา',
    project_detail_launch: 'เปิดตัว',
    project_detail_construction_start: 'เริ่มก่อสร้าง',
    project_detail_completion: 'แล้วเสร็จ',
    project_detail_min_price: 'ราคาเริ่มต้น',
    project_detail_max_price: 'ราคาสูงสุด',
    project_detail_price_per_sqm: 'ราคา/ตร.ม.',
    ...
    project_detail_unit_types: 'ประเภทห้อง',
    project_detail_size_sqm: 'ขนาด (ตร.ม.)',
    project_detail_price: 'ราคา',
    project_detail_current_promotions: 'โปรโมชั่นปัจจุบัน',
    project_detail_no_promotions: 'ไม่มีโปรโมชั่นในขณะนี้',
    project_detail_contact_inquiry: 'ติดต่อสอบถาม',
    project_detail_schedule_visit: 'นัดดูโครงการ',
    project_detail_download_brochure: 'ดาวน์โหลดโบรชัวร์',
  ...
  en: {
    ...
    project_sort: 'Sort By',
    project_sort_completion_nearest: 'Completion Date: Nearest First',
    project_sort_price_low: 'Price: Low to High',
    project_sort_price_high: 'Price: High to Low',
    project_sort_yield_high: 'Yield: High to Low',
    project_sort_units_available: 'Units Available: Most First',
    project_all: 'All',
    project_pre_sale: 'Pre-Sale',
    ...
    project_detail_units: 'Units',
    project_detail_facilities: 'Facilities',
    project_detail_location_map: 'Location Map',
    project_detail_description: 'Project Description',
    project_detail_info: 'Project Info',
    project_detail_pricing: 'Pricing & Finance',
    project_detail_units_info: 'Units Information',
    project_detail_timeline: 'Timeline',
    project_detail_launch: 'Launch',
    project_detail_construction_start: 'Construction Start',
    project_detail_completion: 'Completion',
    project_detail_min_price: 'Starting From',
    project_detail_max_price: 'Up To',
    project_detail_price_per_sqm: 'Price/sqm',
    ...
    project_detail_unit_types: 'Unit Types',
    project_detail_size_sqm: 'Size (sqm)',
    project_detail_price: 'Price',
    project_detail_current_promotions: 'Current Promotions',
    project_detail_no_promotions: 'No promotions available at this time',
    project_detail_contact_inquiry: 'Contact for Inquiry',
    project_detail_schedule_visit: 'Schedule a Visit',
    project_detail_download_brochure: 'Download Brochure',

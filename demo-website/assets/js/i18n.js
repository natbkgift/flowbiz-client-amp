...
const TRANSLATIONS = {
  th: {
    ...
    calc_projection_title: 'ประมาณการกระแสเงินสด (10 ปี)',
    calc_projection_subtitle: 'แสดงกระแสเงินสดรายเดือนหลังหักค่าใช้จ่าย',
    calc_projection_assumptions: 'สมมติว่าอัตราค่าเช่าและค่าใช้จ่ายคงที่ตลอดช่วงเวลา และยอดผ่อนหนี้สิ้นสุดเมื่อครบกำหนดสัญญา',
    calc_projection_chart_label: 'กระแสเงินสดสุทธิรายเดือน',
    calc_projection_month: 'เดือน',
    calc_projection_income: 'รายรับ',
    calc_projection_expenses: 'รายจ่าย',
    calc_projection_loan_payment: 'ยอดผ่อน',
    calc_projection_net_cash_flow: 'กระแสเงินสดสุทธิ',
    ...
    areas_index_intro: 'เปรียบเทียบราคา แนวโน้ม และสิ่งอำนวยความสะดวกในทุกพื้นที่หลัก',
    ...
    area_charts_title: 'เปรียบเทียบราคาพื้นที่',
    area_charts_subtitle: 'เปรียบเทียบราคาเฉลี่ยและการเติบโตเทียบปีต่อปีของพื้นที่สำคัญในพัทยา',
    area_chart_price_title: 'ราคาเฉลี่ยต่อ ตร.ม.',
    area_chart_trend_title: 'แนวโน้มราคา YoY',
    area_chart_high_label: 'สูงสุด',
    area_chart_low_label: 'ต่ำสุด',
    ...
    areas_breadcrumb: 'พื้นที่',
    area_detail_competitive: 'ราคาแข่งขันได้',
    area_detail_growing: 'ตลาดกำลังเติบโต',
    area_properties_title: 'อสังหาในพื้นที่',
    area_properties_subtitle: 'สำรวจอสังหาที่มีให้เลือกในพื้นที่นี้',
    area_view_all_properties: 'ดูอสังหาทั้งหมด',
    area_no_properties: 'ยังไม่มีอสังหาในพื้นที่นี้ในขณะนี้',
    area_cta_title: 'สนใจพื้นที่นี้หรือไม่?',
    area_cta_subtitle: 'ให้ผู้เชี่ยวชาญของเราช่วยคุณหาอสังหาที่เหมาะสม',
    area_cta_contact: 'ติดต่อเรา',
    area_cta_search: 'ค้นหาอสังหา',
  ...
  en: {
    ...
    calc_projection_title: 'Cash Flow Projection (10 Years)',
    calc_projection_subtitle: 'Monthly cash flow after expenses and loan payment',
    calc_projection_assumptions: 'Assumes rent and expenses stay constant throughout the period, and loan payments stop after the loan term ends.',
    calc_projection_chart_label: 'Net Monthly Cash Flow',
    calc_projection_month: 'Month',
    calc_projection_income: 'Income',
    calc_projection_expenses: 'Expenses',
    calc_projection_loan_payment: 'Loan Payment',
    calc_projection_net_cash_flow: 'Net Cash Flow',
    ...
    areas_index_intro: 'Compare prices, trends, and amenities across all major areas',
    ...
    area_charts_title: 'Area Price Comparison',
    area_charts_subtitle: 'Compare average prices and year-on-year growth across key Pattaya areas.',
    area_chart_price_title: 'Average Price per sqm',
    area_chart_trend_title: 'YoY Price Growth',
    area_chart_high_label: 'Highest',
    area_chart_low_label: 'Lowest',
    ...
    areas_breadcrumb: 'Areas',
    area_detail_competitive: 'Competitive pricing',
    area_detail_growing: 'Growing market',
    area_properties_title: 'Properties in',
    area_properties_subtitle: 'Explore available properties in this area',
    area_view_all_properties: 'View All Properties',
    area_no_properties: 'No properties available in this area at the moment.',
    area_cta_title: 'Interested in This Area?',
    area_cta_subtitle: 'Let our experts help you find the perfect property',
    area_cta_contact: 'Contact Us',
    area_cta_search: 'Search Properties',

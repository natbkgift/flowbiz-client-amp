  ...
  it('keeps the primary CTA on-page and renders a single form intro via LeadForm props', () => {
    const { container } = render(
      <HomeBottomCta
        ...
        conversionNote="Limited units available - request current pricing now."
    ...
    expect(screen.getByText('Limited units available - request current pricing now.')).toBeInTheDocument();

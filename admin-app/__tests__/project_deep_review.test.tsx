...
describe('ProjectDeepReview', () => {
  ...
  it('localizes deep review framing on the Thai route', () => {
    ...
    expect(screen.getByRole('heading', { name: 'จุดที่ช่วยเสริมความมั่นใจ' })).toBeTruthy();
    expect(screen.getByRole('heading', { name: 'ภาพรวมการลงทุนจาก snapshot' })).toBeTruthy();
    expect(screen.getByLabelText(/วิธีอ่าน snapshot นี้/i)).toBeTruthy();
  });
});
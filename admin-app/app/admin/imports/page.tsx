...
const copy = {
  en: {
    ...
    subtitle: "Run one import, review the result, and confirm import health without leaving the page.",
    ...
    filterDryRun: "Run mode",
    sessionActive: "Session active",
    importRunDescription: "Upload one CSV, choose dry-run or live mode, and keep the next action visible above the fold.",
    ...
    importHistoryDescription: "Recent import runs with status, source file, row counts, and runtime.",
  ...
  th: {
    ...
    title: "ติดตามการนำเข้า",
    subtitle: "รันงานนำเข้า ดูผลลัพธ์ และยืนยันสุขภาพของรอบล่าสุดได้จากหน้าเดียว",
    ...
    imports: "รอบการรันล่าสุด",
    mirror: "สุขภาพมิเรอร์",
    deploy: "สุขภาพการเผยแพร่",
    checkedAt: "เวลาตรวจสอบ",
    total: "ทั้งหมด",
    empty: "ยังไม่มีรายการ import",
    emptyHint: "เริ่มงานนำเข้าหรือผ่อนตัวกรองเพื่อดูประวัติเพิ่มเติม",
    filterStatus: "สถานะรอบการรัน",
    filterDryRun: "โหมดการรัน",
    sessionActive: "เซสชันพร้อมใช้งาน",
    importRunDescription: "อัปโหลด CSV หนึ่งไฟล์ เลือกโหมดทดลองหรือรันจริง และดูงานถัดไปได้ทันทีเหนือ fold",
    importSelectionHint: "เตรียมไฟล์ไว้หนึ่งชุด เลือกโหมดทดลองรันเมื่อต้องตรวจ mapping แล้วค่อยดูผลลัพธ์ก่อนสั่งรันจริง",
    importHistoryDescription: "รอบการรันล่าสุด พร้อมสถานะ ไฟล์ จำนวนแถว และเวลาที่ใช้ในการประมวลผล",

...
const copy = {
  en: {
    ...
    emptyOverrides: "No overrides yet. TODO: add key pages.",
    emptyRedirects: "No redirects yet. TODO: add legacy paths.",
    emptyReport: "No report yet. TODO: run checker.",
    emptySchema: "Schema source empty. TODO: fill approved business data.",
  },
  th: {
    ...
    emptyOverrides: "ยังไม่มี overrides TODO: เพิ่มหน้าสำคัญ",
    emptyRedirects: "ยังไม่มี redirects TODO: เพิ่ม path เดิม",
    emptyReport: "ยังไม่มีรายงาน TODO: รัน checker",
    emptySchema: "ข้อมูล schema ยังว่าง TODO: เติมข้อมูลธุรกิจที่อนุมัติ",
  },
};

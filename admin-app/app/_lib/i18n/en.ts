...
const enMessaging = {
  valueProposition: {
    ...
    homeHeroSubtitle: 'Share your brief with AMP and the Pattaya team will narrow the areas, projects, and ownership path worth your time.',
...
export const en: Dictionary = {
  ...
  home: {
    ...
    featuredSubtitle: 'A calmer first read of the developments the team would open before the rest of the market.',
    insightTitle: 'Pattaya only works when the brief and the area fit each other',
    insightSubtitle: 'Area, ownership route, and price discipline matter more than opening more tabs.',
    insightCards: [
    ...
    premiumCtaTitle: 'Start the conversation with your Pattaya brief',
    premiumCtaBody:
      'Share your budget, timing, preferred areas, and whether this is for living, investment, or a second home. AMP will come back with a more focused first set.',
    premiumCtaPrimary: enMessaging.ctaLanguage.sendBrief,
    premiumCtaSecondary: 'Review Current Projects',
    premiumCtaTrustNote: 'You will hear back from the Pattaya team with practical guidance, not a generic listing dump.',
    ...
    pathSectionTitle: 'Choose the advisory route that fits your goal',
    pathSectionSubtitle: 'Start with buying or investment guidance. If you need renting, relocation, or owner support, the team can direct you without adding another loop.',
    trustSubtitle: 'Local guidance, curated options, and foreign-buyer clarity before you commit further.',

      ...
      <div className="container animate-pulse">
        ...
        <div className="grid grid-3 gap-6">
          {Array.from({ length: 6 }).map((_, idx) => (
            <div key={idx} className="rounded-xl bg-[var(--color-white)] p-4">
              <div className="mb-4 h-40 rounded bg-[var(--color-border)]" />
              <div className="mb-2 h-6 w-2/3 rounded bg-[var(--color-border)]" />

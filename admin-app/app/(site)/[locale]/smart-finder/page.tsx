...
import { SmartFinderEventTracker } from './SmartFinderEventTracker';
          ...
          <div className="card reveal">
              ...
              <form method="GET" action={baseAction} className="guided-grid">
                ...
                <div className="guided-row">
                  <button
                    ...
                    name="foreign_quota"
                    value="required"
                    data-amp-event-type="smart_finder_submit"
                    data-amp-event-payload={JSON.stringify({ foreign_quota: 'required' })}
                  >
                  ...
                  <button
                    ...
                    value="unsure"
                    data-amp-event-type="smart_finder_submit"
                    data-amp-event-payload={JSON.stringify({ foreign_quota: 'unsure' })}
                  >
                  ...
                  <button
                    ...
                    value="not_required"
                    data-amp-event-type="smart_finder_submit"
                    data-amp-event-payload={JSON.stringify({ foreign_quota: 'not_required' })}
                  >
            ...
            {effectiveStep === 'results' ? (
              <div className="guided-grid">
                ...
                {resultsError ? (
                  <div className="trust-box" role="status" aria-live="polite">
                    <h3 className="trust-box__title">{dict.smartFinder.noProjects}</h3>
                    <p className="section-subtitle">{dict.smartFinder.noProjectsDescription}</p>
                    <div className="cta-row">
                      ...
                      <div key={it.project_id} className="card">
                        ...
                        <div className="card-actions mt-4">
                          <Link
                            ...
                            data-amp-event-type="smart_finder_result_cta_click"
                            data-amp-event-payload={JSON.stringify({ action: 'view_project', project_id: it.project_id, project_slug: it.slug })}
                          >
                            {dict.smartFinder.viewProject}
                          </Link>
                          <Link
                            className="btn btn-secondary"
                            href={withLocale(locale, `/compare?ids=${encodeURIComponent(it.project_id)}`)}
                            data-amp-event-type="smart_finder_result_cta_click"
                            data-amp-event-payload={JSON.stringify({ action: 'compare', project_id: it.project_id })}
                          >

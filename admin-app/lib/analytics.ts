 ...
 * - `smart_finder_step_progress` — Smart Finder wizard step viewed.
 * - `smart_finder_submit`        — Smart Finder final step submitted.
 * - `smart_finder_result_cta_click` — Smart Finder result CTA clicked.
 * - `compare_item_added`         — Compare page loaded item from ids list.
 * - `compare_item_removed`       — Compare page id missing/invalid.
 * - `compare_cta_click`          — Compare CTA clicked.
 */

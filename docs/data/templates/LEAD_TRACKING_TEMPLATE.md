...
> 📊 Schema สำหรับ Lead Tracking & CRM Database พร้อมระบบรายงานอัตโนมัติ

## Overview

Lead Tracking Template คือ CRM database สำหรับจัดการ leads ทั้งหมดของ AMP ตั้งแต่การรับ lead จนถึงการ convert เป็น customer พร้อมระบบรายงานอัตโนมัติและการแจ้งเตือนผ่าน LINE

### ✨ New Features: Automated Reporting System

- 📊 **Daily Reports**: รายงานสรุปอัตโนมัติทุกเช้า
- 📈 **Weekly Analytics**: สรุปประสิทธิภาพประจำสัปดาห์
- 🔔 **LINE Notifications**: แจ้งเตือนงานและ leads สำคัญ
- 🤖 **Google Apps Script**: Automation ด้วย Apps Script
- 📉 **Python Analytics**: วิเคราะห์ข้อมูลขั้นสูง

### 📚 Documentation

สำหรับข้อมูลโดยละเอียดเกี่ยวกับระบบ Automated Reporting:

- **[Google Sheets Overview](google-sheets/README.md)** - ภาพรวมระบบรายงานอัตโนมัติ
- **[Setup Guide](google-sheets/SETUP_GUIDE.md)** - คู่มือติดตั้งและตั้งค่าแบบละเอียด
- **[Schema Reference](google-sheets/SCHEMA_REFERENCE.md)** - Schema อ้างอิงฉบับสมบูรณ์

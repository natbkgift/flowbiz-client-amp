...
?>        
        ...
        <div class="slider">
<?php
                  $cities = zbSQLAssocMulti("SELECT * FROM cities ORDER BY sortOrder");
                  for($n=0; $n<count($cities); $n++) {
?>                    
                    <a href='' onclick='alert("go to that city"); return false;'>
                    <div>
                      <img src="mv/cities/<?=$cities[$n]["pic"]?>" alt=''>
                      <br>
                      <h2 class='text-center'>
                        1,234 properties in <?=$cities[$n]['name']?>
                      </h2>
                    </div>
                    </a>
<?php                    

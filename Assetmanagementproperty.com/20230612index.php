<?php
  ...
  define ("DB_USERNAME", "localtha_amp");
  define ("DB_PASSWORD", "amp_30772");
  define ("DB_NAME", "localtha_amp");

  define ("WEBSITE_URL", "https://www.assetmanagementproperty.com");
...
<?php
                                                  ...
                                                  while ($r = $result->fetch_array(MYSQLI_ASSOC)) {
                                                    echo "<li><a href='?pageid=all&search=true&cat1={$r["cat1"]}'>{$r["cat1"]}</a></li>";
                                                  }
?>                  
                                            </ul>
                                        </li>
...
<?php                        
                          if ($search=='true') {
                            ...
                            if ($cat1) 
                              if ($cat1 != $w["any"][$lang])
                                $s .= " AND UPPER(cat1)=UPPER('$cat1') ";
                            if ($cat2) 
                              if ($cat2 != $w["any"][$lang])
                                $s .= " AND UPPER(cat2)=UPPER('$cat2') ";
                            if ($minArea) 
                              $s .= " AND area>='$minArea' ";
                            if ($maxArea) 
                              $s .= " AND area<='$maxArea' ";
...
?>
                                        <div role="tabpanel" class="tab-pane fade in <?php if ($n==1) echo "active";?>" id="pro-<?php echo $n;?>">
                                            <a href="images/single-property/big/<?php echo $h["img$n"]; ?>" data-lightbox="image-1" data-title="Property <?php echo $n;?>">
                                                <img src="images/single-property/big/<?php echo $h["img$n"];?>" alt="">
                                            </a>
                                        </div>
<?php
                                        $n++;
...
?>
                                    <div class="pro-details-item">
                                        <a href="#pro-<?php echo $n;?>" data-toggle="tab"><img src="images/single-property/big/<?php echo $h["img$n"];?>" alt=""></a>
                                    </div>
<?php
                                        $n++;
                                        if ($n>10)
...
?>                                                    
                                                ...
                                                <p><img style="background: black; mix-blend-mode: difference;" src="images/icons/location.png" alt=""><?php echo $h["address"];?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-12">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3 col-xs-12">
                            <div class="section-title text-white">
                                <h3><?php echo $w["findHome1"][$lang];?></h3>
                                <h2 class="h1"><?php echo $w["findHome2"][$lang];?></h2>
                            </div>
                        </div>
                        <form id="searchForm">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="find-home-item custom-select">
                                            <select name="cat1" class="selectpicker" title="<?php echo $w["location"][$lang];?>" data-hide-disabled="false">
                                                <option><?php echo $w["any"][$lang];?></option>
<?php
                                                  $result = $conn->query("SELECT DISTINCT UPPER(cat1) AS cat1 FROM home WHERE cat1<>'' ORDER BY cat1");
                                                  while ($r = $result->fetch_array(MYSQLI_ASSOC)) {
                                                    echo "<option>{$r["cat1"]}</option>";
                                                  }
?>                                                
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="find-home-item custom-select">                  
                                            <select name="cat2" class="selectpicker" title="<?php echo $w["sublocation"][$lang];?>" data-hide-disabled="true" data-live-search="true">
                                                <option><?php echo $w["any"][$lang];?></option>
<?php
                                                  $result = $conn->query("SELECT DISTINCT UPPER(cat2) AS cat2 FROM home WHERE cat2<>'' ORDER BY cat2");
                                                  while ($r = $result->fetch_array(MYSQLI_ASSOC)) {
                                                    echo "<option>{$r["cat2"]}</option>";
                                                  }
?>                                                
                                            </select>
                                        </div> 
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="find-home-item">
                                            <input type="text" name="min-area" placeholder="<?php echo $w["minArea"][$lang];?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="find-home-item">
                                            <input type="text" name="max-area" placeholder="<?php echo $w["maxArea"][$lang];?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="find-home-item custom-select">                  
                                            <select name="bed" class="selectpicker" title="<?php echo $w["bedrooms"][$lang];?>" data-hide-disabled="true">
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="find-home-item custom-select">                  
                                            <select id="typeOfSale" name="type" class="selectpicker" title="<?php echo $w["typeOfProperty"][$lang];?>" data-hide-disabled="true">
                                              <option value='any'><?php echo $w["typeAll"][$lang];?></option>
                                              <option value='sale'><?php echo $w["typeSale"][$lang];?></option>
                                              <option value='rent'><?php echo $w["typeRent"][$lang];?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                              <div id="bigDivSelectPriceSale" class="find-home-item custom-select">                  
                                              <?php 
                                                echo $priceSaleOptions;
                                              ?>
                                              </div>
                                              <div id="bigDivSelectPriceRent" class="find-home-item custom-select" style="display:none;">
                                              <?php 
                                                echo $priceRentOptions;
                                              ?>
                                              </div>
                                            </div>
                                            <div class="col-sm-6 col-xs-12">
